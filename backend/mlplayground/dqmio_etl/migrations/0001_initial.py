...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Run',
            fields=[
                ('run_number', models.IntegerField(primary_key=True, serialize=False, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lumisection', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='%(app_label)s_%(class)s_histograms', to='dqmio_etl.lumisection')),
                ('source_data_file', models.ForeignKey(blank=True, help_text='Source data file that the specific Histogram was read from, if any', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s', to='dqmio_file_indexer.fileindex')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(max_length=220)),
                ('entries', models.IntegerField(blank=True, null=True)),
                ('data', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(), blank=True, size=None), blank=True, size=None)),
                ('x_min', models.FloatField(blank=True, null=True)),
                ('x_max', models.FloatField(blank=True, null=True)),
                ('x_bin', models.IntegerField(blank=True, null=True)),
        ...
        migrations.AddField(
            ...
            name='run',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='lumisections', to='dqmio_etl.run'),
        ),
        migrations.AddField(
            model_name='runhistogram',
            name='run',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='histograms', to='dqmio_etl.run'),
        ),
        migrations.AddField(
            model_name='runhistogram',
            name='source_data_file',
            field=models.ForeignKey(blank=True, help_text='Source data file that the specific Histogram was read from, if any', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s', to='dqmio_file_indexer.fileindex'),
        ),
        migrations.AddConstraint(
